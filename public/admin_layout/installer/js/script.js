...
(function ($, window, document, undefined) {
    ...
    function getButtonsTemplate(settings) {
        var $buttons = $("" +
                ...
                "<div class='col-md-12'>" +
                "<button class='btn btn-success pull-left aiia-wizard-button-previous'></button>" +
                "<button class='btn btn-success pull-right aiia-wizard-button-next' data-loading-text='" + settings.aiiaWizard.localization.buttons.loading + "'></button>" +
                "</div>" +
                "</div>" +
                "").css({
            'display': 'block'
