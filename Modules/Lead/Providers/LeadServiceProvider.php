...
class LeadServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            module_path('Lead', 'Config/config.php') => config_path('lead.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Lead', 'Config/config.php'), 'lead'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('Lead', 'Resources/views');
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Lead', 'Database/factories'));
        }
    }
