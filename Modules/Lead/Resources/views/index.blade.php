					...
					<div class="table_basic">
						<div class=" text-right">
							...
							<div class="d-inline card_buttons">
								  @if(\Auth::User()->can('export',app('Modules\Lead\Entities\Lead')))
								<div class="dropdown d-inline">
									...
									<div class="dropdown-menu dropdown-menu-right export_data">
										<ul class="">
											...
											<li class="printMe">
												<a href="{{route('leads.print_file')}}" target="_blank" class="">
													<i class=""></i>
													<span class="">@lang('layout.print')</span>
												</a>
											</li>
											<li class="export_file">
												<a href="{{route('leads.export_excel_file')}}" class="" >
													<i class=""></i>
													<span class="">@lang('layout.excel')</span>
												</a>
											</li>
											<li class="export_file">
												<a href="{{route('leads.export_csv_file')}}" class="">
													<i class=""></i>
													<span class="">@lang('layout.csv')</span>
												</a>
											</li>
											<li>
												<a href="{{route('leads.export_pdf_file')}}" class="" target="_blank">
													<i class=""></i>
								...
								@endif
								 @if(\Auth::User()->can('add',app('Modules\Lead\Entities\Lead')))
								 <div class="dropdown d-inline lead_import_data">
									<button type="button" class="btn btn-base btn-icon-sm dropdown-toggle btn-toggle-none mb-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<ul class="">
											...
											<li class="lead_import_file" id="file-id-1">
												<a class="">
													<i class=""></i>
													<span class="">@lang('layout.excel')</span>
												</a>
											</li>
											<li class="lead_import_file" id="file-id-2">
												<a class="">
								...
								<button class="btn btn-base mb-2 add_lead"><i class="fas fa-plus"></i> @lang('leads.new_lead')</button>
								@endif
							</div>
						</div>
						<hr>
...
@section('js')
<script src="{{asset('public/admin_layout/plugins/datetimepicker/datetimepicker.min.js')}}?v={{ $version }}"></script>
<script src="{{asset('public/admin_layout/js/Modules/Leads/index.js')}}?v={{ $version }}"></script>
@endsection
