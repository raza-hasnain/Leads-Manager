{!!Form::open(['route'=>array('leads.import_file',$file_type_id),'id'=>'lead-import-form','enctype' => 'multipart/form-data']) !!}
<div class="modal-header">
    <h5 class="modal-title">@lang('leads.import_leads')</h5>
...
<div class="modal-body">
    ...
    <div class="form-group m-form__group row">
        ...
        <div class="col-lg-12 row pt-3">
            ...
            <div class="col-lg-6">
                <a href="{{route('leads.download',$file_type_id)}}" ><button type="button" class="btn btn-success float-right " >@lang('layout.download_demo')</button></a>
            </div>
        </div>
    </div>
</div>
...
{!! Form::close() !!}
<script src="{{asset('public/admin_layout/js/Modules/Leads/import_lead.js')}}?v={{ $version }}"></script>  