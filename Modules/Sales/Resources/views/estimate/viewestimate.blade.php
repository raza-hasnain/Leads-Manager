    ...
    <div class="content-header">
        ...
        <div class="header-title">
            <div class="lead_name">
                <h1>@if($estimate->type == 0)@lang('sales.estimates')-@else @lang('sales.proposals')- @endif {{clean($estimate->title)}}</h1>
            ...
            <ul class="more">
                <li class="dropdown float-right">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li><a class="px-2 edit-tr" id="edit-tr-{{$estimate->id}}"><i class="fas fa-edit pr-1"></i> @lang('layout.edit_details')</a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="card profile-card">
                ...
                <div class="card-content">
                    ...
                    <div class="card-content-summary ">
                        <table>
                            <h5>@lang('layout.contact_info')</h5>
                            <tbody>
                                <tr>
            ...
            <div class="card mb-4">
                <div class="card-header" id="proposed_persondetails">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">@if($estimate->type == 0)@lang('sales.estimate_items')-@else @lang('sales.proposal_items') @endif</h6>
                        </div>
                    </div>  
                </div> 
            <div class="row">
                    ...
                    <table class="table text-right">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="total">{{clean($estimate->discount_rate)}}</td>
                            </tr>
...
<script src="{{asset('public/admin_layout/js/Modules/Estimates/view_estimate.js')}}?v={{ $version }}"></script>