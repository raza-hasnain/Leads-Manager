{!!Form::open(['route'=>array('estimates.edit',$estimate->id),'id'=>'edit-estimate-form','enctype' => 'multipart/form-data']) !!}
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0">@lang('sales.update_estimate')</h6>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">@lang('sales.estimate_details')</h6>
                    </div>
                </div>
            </div> 
            <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="phone" class="form-control m-input m-input--solid"  value="@if($estimate->phone_no){{clean($estimate->phone_no)}} @else {{clean($member->phone)}}@endif">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                        ...
                        <tr>
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" id="adjustment-data" min="1" v-model="adjustment" onblur="justment(this)"  class="form-control form-control-sm text-right" name="adjustment" value="{{clean($estimate->adjustment)}}">
                                    </div>
                                </div>
                            </td>
                            <td class="adjustment">
