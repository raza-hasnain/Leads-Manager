{!!Form::open(['route'=>array('proposals.edit',$estimate->id),'id'=>'edit-estimate-form','enctype' => 'multipart/form-data']) !!}
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 font-weight-600 mb-0">@lang('sales.update_proposal')</h6>
            </div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">@lang('sales.proposal_details')</h6>
                    </div>
                </div>
            </div> 
            <div class="card-body">
                <div class="form-group m-form__group row">
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="title" class="form-control m-input m-input--solid" value="{{clean($estimate->title)}}">
                    </div>
                    <div class="col-lg-2">
                        <label>
                    ...
                    <div class="col-lg-2 module_select">
                        ...
                        <input type="text" name="module_id" class="form-control m-input m-input--solid" value="{{clean($estimate->source->module_name)}}" disabled>
                    </div>
                    <div class="col-lg-4 module_member">
                        <label class="label">
                            @lang('layout.select_name') @required
                        </label>
                        <input type="text" name="module_member_id" class="form-control m-input m-input--solid" value="@if($member->name){{clean($member->name)}}@else{{clean($member->first_name).' '.clean($member->last_name)}}@endif" disabled>
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <textarea class="form-control" name="client_note" id="post_text" rows="1" placeholder="@lang('layout.client_note')" value="{{clean($estimate->client_note) }}" ></textarea>
                    </div>
                </div>
            </div> 
        </div>
            ...
            <div class="card-body">
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="email" name="email" class="form-control m-input m-input--solid" placeholder="@lang('layout.email')" value="{{clean($estimate->email)}}">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="phone" class="form-control m-input m-input--solid" placeholder="@lang('layout.phone_number')" value="@if($estimate->phone_no){{clean($estimate->phone_no)}} @else {{clean($member->phone)}}@endif">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="number" name="zip_code" class="form-control m-input m-input--solid" placeholder="@lang('layout.postal_code')" value="{{ $estimate->zip_code ? clean($estimate->zip_code) : '' }}">
                    </div>
                </div>
            </div> 
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="10%" class="cal">
                                <input type="number" min="1" name="quantity[]" placeholder="Quantity" class="form-control form-control-sm text-center calculate_sub quantity" autocomplete="off" value="{{clean($item->quantity)}}">
                            </td>
                            <td width="10%" class="cal">
                                <input type="number" min="1" name="rate[]" placeholder="Rate" aria-invalid="false" class="form-control form-control-sm text-center calculate_sub rate" autocomplete="off" required value="{{clean($item->rate)}}">
                            </td>
                            <td>
                ...
                <table class="table text-right">
                    <tbody>
                        ...
                        <tr id="subtotal">
                            ...
                            <td class="sub_total"><span class="su_total"></span>  <input type="hidden" id="sub_total" name="sub_ptotal" value="{{clean($estimate->sub_ptotal)}}"></td>
                        </tr>
                        <tr id="discount_area">
                            <td>
                                <div class="row">
    ...
    <div class="col-sm-12 text-right submit-proposal mb-2">
        <button type="button" class="btn btn-danger" data-dismiss="modal"><a href="{{route('proposals.index')}}" class="text-white">@lang('layout.back')</a></button>
        <button id="submit_proposal" type="button" class="btn btn-success mr-5">@lang('layout.save')</button>
    </div>
</div>
<script src="{{asset('public/admin_layout/js/Modules/Proposals/edit.js')}}?v={{ $version }}"></script>