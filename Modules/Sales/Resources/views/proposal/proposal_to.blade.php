    ...
    <div class="card-body">
        ...
        <div class="form-group m-form__group row">
            ...
            <div class="col-lg-4">
                ...
                <input type="text" name="phone_no" class="form-control m-input m-input--solid" placeholder="@lang('layout.phone_number')" value="{{clean($member->phone) ? ''}}">
            </div>
        </div>
        <div class="form-group m-form__group row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-3">
                ...
                <input type="text" name="zip_code" class="form-control m-input m-input--solid" placeholder="@lang('layout.postal_code')" value="{{clean($member->zip_code)}}">
            </div>
        </div>
    </div> 
</div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item text-right" onclick="discountMethodChanged(1,'f');"  >@lang('invoice.fixed_amount')</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script src="{{asset('public/admin_layout/js/Modules/Estimates/member_to.js')}}?v={{ $version }}"></script>